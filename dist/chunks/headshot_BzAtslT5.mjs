const headshot = new Proxy({"src":"/_astro/headshot.CBvZPe_i.jpeg","width":321,"height":321,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/Users/tiffanychen/Documents/Projects : Dev/tiffanyjc.github.io/src/assets/headshot.jpeg");
							return target[name];
						}
					});
