const anduril = new Proxy({"src":"/_astro/anduril.C8bPhDJb.jpeg","width":225,"height":225,"format":"jpg"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/Users/tiffanychen/Documents/Projects : Dev/tiffanyjc.github.io/src/assets/anduril.jpeg");
							return target[name];
						}
					});
