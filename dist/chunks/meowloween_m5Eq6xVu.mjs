const meowloween = new Proxy({"src":"/_astro/meowloween.DBg8lq5N.jpeg","width":1280,"height":1657,"format":"jpg"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/Users/tiffanychen/Documents/Projects : Dev/tiffanyjc.github.io/src/assets/meowloween.jpeg");
							return target[name];
						}
					});
