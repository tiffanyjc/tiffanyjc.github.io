const wipBook = new Proxy({"src":"/_astro/wipBook.CSUU6FO_.png","width":479,"height":595,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/Users/tiffanychen/Documents/Projects : Dev/tiffanyjc.github.io/src/assets/wipBook.png");
							return target[name];
						}
					});
