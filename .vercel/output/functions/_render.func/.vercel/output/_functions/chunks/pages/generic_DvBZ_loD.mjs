import { A as AstroError, n as ExpectedImageOptions, E as ExpectedImage, o as FailedToFetchRemoteImageDimensions, p as InvalidImageService, c as createAstro, d as createComponent, q as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, e as addAttribute, s as spreadAttributes, t as AstroError$1, v as InvalidImageService$1 } from '../astro_C3K8O79i.mjs';
import { r as resolveSrc, i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS, c as isRemotePath, d as isRemoteAllowed } from '../astro/assets-service_CVVM5bWV.mjs';
import 'clsx';
...
async function getConfiguredImageService$1() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_CVVM5bWV.mjs'
    ).then(n => n.k).catch((e) => {
